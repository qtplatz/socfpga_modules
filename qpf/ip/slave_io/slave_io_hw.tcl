...
set_module_property NAME slave_io
set_module_property VERSION 2.0
set_module_property GROUP Templates
set_module_property AUTHOR JCJB
set_module_property DISPLAY_NAME slave_io
set_module_property TOP_LEVEL_HDL_FILE slave_io.v
set_module_property TOP_LEVEL_HDL_MODULE slave_io
...
# | files
# |
add_file slave_io.v {SYNTHESIS SIMULATION}
...
add_parameter IRQ_EN int 0 "Enable or disable the interrupt capabilities of input ports"
set_parameter_property IRQ_EN DISPLAY_NAME "Interrupt capabilities"
set_parameter_property IRQ_EN GROUP "Interrupt"
set_parameter_property IRQ_EN AFFECTS_PORT_WIDTHS true
...
set_interface_property slv_irq ASSOCIATED_CLOCK clock_reset
...
proc validate_me {} {
  ...
  ## ----------------------- turning on or off the interrupt enable GUI ----------------------------
  expr {((($the_mode_0 == 1) || ($the_mode_0 == 2))
  || (($the_mode_1 == 1) || ($the_mode_1 == 2))
  || (($the_mode_2 == 1) || ($the_mode_2 == 2))
  || (($the_mode_3 == 1) || ($the_mode_3 == 2))
  || (($the_mode_4 == 1) || ($the_mode_4 == 2))
  || (($the_mode_5 == 1) || ($the_mode_5 == 2))
  || (($the_mode_6 == 1) || ($the_mode_6 == 2))
  || (($the_mode_7 == 1) || ($the_mode_7 == 2))
  || (($the_mode_8 == 1) || ($the_mode_8 == 2))
  || (($the_mode_9 == 1) || ($the_mode_9 == 2))
  || (($the_mode_10 == 1) || ($the_mode_10 == 2))
  || (($the_mode_11 == 1) || ($the_mode_11 == 2))
  || (($the_mode_12 == 1) || ($the_mode_12 == 2))
  || (($the_mode_13 == 1) || ($the_mode_13 == 2))
  || (($the_mode_14 == 1) || ($the_mode_14 == 2))
  || (($the_mode_15 == 1) || ($the_mode_15 == 2)))
  ? [set_parameter_property IRQ_EN ENABLED TRUE] : [set_parameter_property IRQ_EN ENABLED FALSE]};
}
