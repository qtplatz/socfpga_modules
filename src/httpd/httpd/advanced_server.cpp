    ...
    , Send&& send)
{
    ...
    // ADDEBUG() << "request_handler: " << req.method() << "; uri=" << req.target();
...
public:
    ...
    template<class Body, class Allocator>  void
...
private:
    ...
    on_read(  beast::error_code ec, std::size_t bytes_transferred )   {
        ...
        ADDEBUG() << beast::make_printable( buffer_.data() );
...
private:
    ...
    on_read(beast::error_code ec, std::size_t bytes_transferred)  {
        ...
        if ( websocket::is_upgrade( parser_->get() ) )  {
            ADDEBUG() << "====== on_read ========== :" << bytes_transferred << " is WebSocket Upgrade";
...
int main(int argc, char* argv[])
{
    ...
    //<-------------
    // The SSL context is required, and holds certificates <-- link error
