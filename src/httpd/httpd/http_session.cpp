...
// Report a failure
void
http_session::fail( beast::error_code ec, char const *what )
{
...
void
http_session::on_read( beast::error_code ec, std::size_t )
{
...
void
http_session::on_write( beast::error_code ec, std::size_t, bool close )
{
    // Handle the error, if any
    if ( ec )
