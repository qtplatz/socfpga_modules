...
void
websocket_session::fail( beast::error_code ec
                         , char const *what )
{
    // Don't report these
...
void
websocket_session::on_accept( beast::error_code ec )
{
...
void
websocket_session::on_read( beast::error_code ec
                            , std::size_t )
{
    // Handle the error, if any
    if ( ec )
...
void
websocket_session::on_write( beast::error_code ec, std::size_t )
{
    // Handle the error, if any
    if ( ec )
